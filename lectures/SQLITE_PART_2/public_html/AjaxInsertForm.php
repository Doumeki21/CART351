 ...
 if($_FILES)
  {
   ...
   try {
    ...
    /*The data from the text box is potentially unsafe; 'tainted'. Use the quote() - puts quotes around things..
      ...
      $queryInsert ="INSERT INTO animalCollectionSub(artist, title, geoLoc, creationDate, descript,image, uID) VALUES ('$u_name',$title_es,$loc_es,$description_es,$creationDate_es,'$imageWithPath','$u_id')";
